...
dict(
    ...
    hero_media=dict(tipo="foto", ar="4/5", testo="Maschera per sedazione cosciente, still life", scena="maschera",
                    nota="Luce morbida e fondo neutro caldo, mascherina appoggiata e non indossata."),
    keyfacts=[
    ...
    proofs=[
        ...
        ("goccia", "Tre modi di sedare, dal più leggero",
         "Oltre all'inalatoria, lo studio pratica l'<b>ansiolisi orale con benzodiazepine</b>, per chi ha bisogno solo di arrivare tranquillo, e la <b>sedazione cosciente endovenosa</b>, gestita direttamente senza appoggiarsi a un anestesista esterno."),
    ...
    prezzo_nota="La sedazione cosciente viene quotata in prima visita in base al tipo e alla durata dell'intervento. Chiedila al telefono quando prenoti.",
    faq=[
        ...
        ("E se ho paura anche solo di venire in studio?", "Dillo quando chiami: la sedazione si può concordare già per la prima seduta, e non serve aspettare di essere un paziente abituale. Nel frattempo <a href='../studio.html#virtuale'>sala d'attesa, sala raggi e zone operative sono tutte su Google Street View</a>: arrivare in un posto già visto è meno faticoso."),
...
dict(
    ...
    hero_media=dict(tipo="foto", ar="4/5", testo="Dettaglio TAC Cone Beam o scanner intraorale in uso", scena="radiologia",
                    nota="Inquadratura stretta sul dettaglio, macchinario tagliato dai bordi."),
    keyfacts=[
    ...
    fit_no=[
        ...
        "Esiste una soluzione meno invasiva a parità di risultato estetico e funzionale",
    ],
    diagramma="impianto",
...
dict(
    ...
    proofs=[
        ...
        ("cuore", "Estetica anche in chirurgia",
         "Quando il problema è la gengiva, il cosiddetto <i>gummy smile</i>, si interviene con la gengivectomia. È una parte del lavoro che incide molto sul risultato finale."),
    ],
    clinico="uberto-piccardo",
...
dict(
    ...
    proofs=[
        ...
        ("euro", "Prezzo dichiarato prima",
         "Otturazione media <b>130 €</b>, estesa <b>160 €</b>, devitalizzazione da <b>160 a 310 €</b> in base al numero di canali. Le cifre sono nel tariffario, prima della visita."),
    ],
    clinico="federico-parodi",
    prezzi=[
...
dict(
    ...
    hero_media=dict(tipo="foto", ar="4/5", testo="Équipe in sala operatoria, dettaglio mani e strumenti", scena="poltrona",
                    nota="Mani e strumenti in campo, volti fuori fuoco. Luce della lampada operatoria."),
    keyfacts=[
    ...
    intro=[
        ("Denti del giudizio",
         "Gli ottavi vanno rimossi quando sono inclusi e creano pericoronite ricorrente, quando danneggiano il dente vicino o quando non c'è spazio per la loro eruzione. Non tutti vanno tolti per principio. Quando serve, <b>la TAC 3D mostra il rapporto con il nervo alveolare</b> prima dell'intervento: è ciò che rende prevedibili la durata e il decorso."),
        ("Parodontologia",
        ...
        ("Innesti di osso e rialzo del seno",
         "Quando l'osso non basta per un impianto lo si ricostruisce. Nel mascellare superiore si esegue il <b>rialzo del seno</b> con apparecchio piezoelettrico; sulle creste sottili si innesta osso del paziente fissato con chiodini; per i difetti piccoli basta una <b>membrana o una griglia in titanio</b>. I prelievi si fanno da <b>zone intraorali</b>, così si evita il prelievo extraorale che richiederebbe un ortopedico. Si eseguono solo dove non esiste altra scelta riabilitativa."),
    ],
...
dict(
    ...
    proofs=[
        ("stella", "Igienisti laureati",
         "Il Dott. <b>Gianluca Grasso</b> e la Dott.ssa <b>Carmela Pulitanò</b>, entrambi laureati in Igiene Dentale. L'igiene dentale è una laurea triennale a sé, con l'esame di Stato."),
...
dict(
    ...
    proofs=[
        ...
        ("scan", "Diagnosi immediata",
         "Radiografie endorali, panoramica e TAC 3D si eseguono <b>in studio, nello stesso momento</b>. Con un dolore in corso resti qui fino alla diagnosi."),
