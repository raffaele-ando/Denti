...
dict(
    ...
    faq=[
        ...
        ("E se ho paura anche solo di venire in studio?", "Chiama e dillo. Si può fissare un primo appuntamento <b>senza alcuna cura</b>: solo per conoscere l'ambiente, parlare e vedere com'è fatto. Molti pazienti hanno iniziato così."),
