...
dict(
    ...
    lead="Duecento euro all'anno di igiene professionale intercettano le carie quando ancora non fanno male e non si vedono, cioè quando costano centotrenta euro invece di millecinquecento. Le sedute sono affidate a due igienisti dentali laureati, comprendono il controllo delle mucose e, per chi ha denti molto sensibili, si possono eseguire in sedazione cosciente.",
    hero_media=None,
    keyfacts=[
    ...
    diagramma_sub="Numeri reali, presi dal nostro tariffario. Messi in fila, questi numeri raccontano una faccenda di aritmetica prima che di buone abitudini.",
    steps=[
